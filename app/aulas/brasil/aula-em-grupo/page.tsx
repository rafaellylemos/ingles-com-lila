  ...
  const groups = [
    {
      ...
      href: "aulas/brasil/aula-em-grupo/zerao"
    },
    {
      ...
      image: "/group-pre.jpg",
      color: "border-gold",
      href: "aulas/brasil/aula-em-grupo/prezao"
    },
    {
      ...
      color: "border-navy",
      href: "aulas/brasil/aula-em-grupo/bzao"
    },
    {
      level: "Avançado (C1)",
      title: "Czão",
      ...
      href: "aulas/brasil/aula-em-grupo/czao"
    }
  ];
      ...
      <section className="py-12 md:py-20 bg-slate-50">
        <div className="container mx-auto px-4">
            ...
            {groups.map((group, index) => (
              ...
              >
                ...
                <div className="p-8 md:p-12 flex flex-col flex-1 text-center items-center">
                  ...
                  {/* Link dinâmico para a página do grupo */}
                  <Link href={group.href} className="w-full">
                    <button className="flex items-center justify-center gap-2 w-full py-5 bg-navy text-white rounded-2xl font-bold hover:bg-gold hover:text-navy transition-all group/btn shadow-lg shadow-navy/10 uppercase tracking-widest text-xs cursor-pointer">
                      {group.buttonText}
          ...
          <div className="mt-24 text-center">
            ...
            <a
              href="https://wa.me/19787939832?text=Olá Lila! Tenho dúvidas sobre qual grupo é o ideal para o meu nível."
              className="inline-flex items-center gap-3 px-10 py-5 bg-gold text-navy rounded-full font-black text-lg shadow-xl hover:scale-105 transition-transform uppercase tracking-tight"
            >
...
export default GroupClassesContent;